Title: AWS S3 Tables MCP Server | Welcome to Open Source MCP Servers for AWS

URL Source: https://awslabs.github.io/mcp/servers/s3-tables-mcp-server

Markdown Content:

## AWS S3 Tables MCP Server

> ## ⚠️ IMPORTANT: YOU ARE RESPONSIBLE FOR YOUR AGENTS[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#%EF%B8%8F-important-you-are-responsible-for-your-agents 'Direct link to ⚠️ IMPORTANT: YOU ARE RESPONSIBLE FOR YOUR AGENTS')
>
...
## Overview[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#overview 'Direct link to Overview')
...
## Features[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#features 'Direct link to Features')
...
## Prerequisites[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#prerequisites 'Direct link to Prerequisites')
...
### Windows Installation[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#windows-installation 'Direct link to Windows Installation')

For Windows users, the MCP server configuration format is slightly different:

`{  "mcpServers": {    "awslabs.s3-tables-mcp-server": {      "disabled": false,      "timeout": 60,      "type": "stdio",      "command": "uv",      "args": [        "tool",        "run",        "--from",        "awslabs.s3-tables-mcp-server@latest",        "awslabs.s3-tables-mcp-server.exe"      ],      "env": {        "FASTMCP_LOG_LEVEL": "ERROR",        "AWS_PROFILE": "your-aws-profile",        "AWS_REGION": "us-east-1"      }    }  }}`

or docker after a successful `docker build -t awslabs/s3-tables-mcp-server.`:

`# fictitious `.env` file with AWS temporary credentialsAWS_ACCESS_KEY_ID=<from the profile you set up>AWS_SECRET_ACCESS_KEY=<from the profile you set up>AWS_SESSION_TOKEN=<from the profile you set up>`

`{  "mcpServers": {    "awslabs.s3-tables-mcp-server": {      "command": "docker",      "args": [        "run",        "--rm",        "--interactive",        "--env-file",        "/full/path/to/file/above/.env",        "awslabs/s3-tables-mcp-server:latest"      ],      "env": {},      "disabled": false,      "autoApprove": []    }  }}`

## Server Configuration Options[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#server-configuration-options 'Direct link to Server Configuration Options')

The AWS S3 Tables MCP Server supports several command-line arguments that can be used to configure its behavior:

### `--allow-write`[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#--allow-write 'Direct link to --allow-write')
...
`{  "mcpServers": {    "awslabs.s3-tables-mcp-server": {      "command": "uvx",      "args": [        "awslabs.s3-tables-mcp-server@latest",        "--allow-write"      ],      "env": {        "AWS_PROFILE": "your-aws-profile",        "AWS_REGION": "us-east-1"      }    }  }}`

### `--log-dir`[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#--log-dir 'Direct link to --log-dir')
...
`{  "mcpServers": {    "awslabs.s3-tables-mcp-server": {      "command": "uvx",      "args": [        "awslabs.s3-tables-mcp-server@latest",        "--log-dir",        "/tmp/s3-tables-logs"      ],      "env": {        "AWS_PROFILE": "your-aws-profile",        "AWS_REGION": "us-east-1"      }    }  }}`

## Usage Examples[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#usage-examples 'Direct link to Usage Examples')
...
## Using Kiro with S3 Tables MCP Server[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#using-kiro-with-s3-tables-mcp-server 'Direct link to Using Kiro with S3 Tables MCP Server')
...
## Security Considerations[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#security-considerations 'Direct link to Security Considerations')
...
## Troubleshooting[​](https://awslabs.github.io/mcp/servers/s3-tables-mcp-server#troubleshooting 'Direct link to Troubleshooting')
...
segune sta doc oficla de aws cual es el verdaero mcp de s3

2026-03-24 13:48:15.104 [warning] [server stderr] programa o archivo por lotes ejecutable.
2026-03-24 13:48:15.135 [info] Estado de conexión: Error Process exited with code 1
2026-03-24 13:48:16.776 [info] Deteniendo servidor aws-s3
2026-03-24 13:48:16.791 [info] Iniciando el servidor aws-s3
2026-03-24 13:48:16.791 [info] Estado de conexión: Iniciando
2026-03-24 13:48:16.805 [info] Starting server from LocalProcess extension host
2026-03-24 13:48:16.805 [info] Estado de conexión: Iniciando
2026-03-24 13:48:16.806 [info] Estado de conexión: En ejecución
2026-03-24 13:48:17.882 [warning] [server stderr] "aws-s3" no se reconoce como un comando interno o externo,
2026-03-24 13:48:17.883 [warning] [server stderr] programa o archivo por lotes ejecutable.
2026-03-24 13:48:17.911 [info] Estado de conexión: Error Process exited with code 1
