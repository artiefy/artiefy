...
const ChatbotModal = () => {
  ...
  const [messages, setMessages] = useState([{ id: 1, text: "¡Hola! ¿En qué puedo ayudarte hoy?", sender: "bot" }])
    ...
    <>
      ...
      >
        ...
        <div className="button__circle">
          ...
          <FaRobot className="button__icon button__icon--copy" aria-hidden="true" />
        </div>
      </button>

      {isOpen && (
        <div className="chat-modal">
          <div className="chat-container" role="dialog" aria-modal="true" aria-labelledby="modal-title">
                  ...
                  >
                    ...
                    <div
                      className={`rounded-lg p-3 ${
                        message.sender === "user" ? "bg-secondary text-white" : "bg-gray-100 text-gray-800"
                      }`}
                    >
                      {message.text}
                    </div>
