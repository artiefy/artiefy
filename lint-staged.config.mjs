...
const config = {
  ...
  '**/*.{ts,tsx,js,jsx}': [
    'node --max-old-space-size=8192 ./node_modules/eslint/bin/eslint.js --config eslint.cli.config.mjs --no-warn-ignored --fix --cache --cache-location .eslintcache',
    'prettier --write --cache',
  ],

  // JSON, Markdown, YAML, CSS, HTML
  '**/*.{json,md,mdx,css,scss,yml,yaml,html}': ['prettier --write --cache'],
