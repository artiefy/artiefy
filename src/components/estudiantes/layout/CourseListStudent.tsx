import { ArrowRightCircleIcon, StarIcon, CheckCircleIcon } from '@heroicons/react/24/solid';
      ...
      <div className="mb-8 grid grid-cols-1 gap-4 px-8 sm:grid-cols-2 lg:grid-cols-3 lg:px-20">
        {await Promise.all(
          courses.map(async (course) => {
            let imageUrl = 'https://placehold.co/600x400/01142B/3AF4EF?text=Artiefy&font=MONTSERRAT';
            let blurDataURL;
            try {
              if (course.coverImageKey && course.coverImageKey !== 'NULL') {
                imageUrl = `${process.env.NEXT_PUBLIC_AWS_S3_URL}/${course.coverImageKey}`.trimEnd();
                    ...
                    <div className="flex w-full items-center justify-between">
                      <Button asChild>
                        ...
                        >
                          ...
                          <ArrowRightCircleIcon className="animate-bounce-right size-5 ml-1 mr-2" />
