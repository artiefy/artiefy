          ...
          <div className="hidden w-full items-center justify-between md:flex">
            ...
            <div>
              <SignedOut>
                <SignInButton>
                  <Button
                    className="relative skew-x-[-15deg] rounded-none p-5 text-xl font-light italic text-primary hover:text-white active:scale-95"
                    style={{
                      transition: '0.5s',
                      width: '175px',
                    }}
                  ...
                  >
                    <span className="relative inline-block skew-x-[15deg] overflow-hidden">
                      {isLoading ? (
