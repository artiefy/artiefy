...
export default function ProyectoGrandeCard() {
  ...
  return (
    <>
      <div className="
        flex h-[75vh] snap-start flex-col justify-between rounded-md
        bg-[#5B5B5B] p-6 text-white shadow-md
      ">
        <div>
          ...
          <div>
            <button
              ...
              className="
                text-2x1 flex items-center gap-1 rounded bg-[#2f2f2f] px-3 py-1
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="
              text-2x1 rounded bg-cyan-300 px-3 py-1 font-semibold text-black
              hover:scale-105
            "
          >
            Ver más
