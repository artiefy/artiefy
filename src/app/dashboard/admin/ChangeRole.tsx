...
import { removeRoleWrapper, setRoleWrapper } from '~/server/wrappers/serverWrappers';
	...
	return (
      ...
      <div className="mt-4 space-y-4">
        ...
        <form action={setRoleWrapper} className="flex items-center space-x-4">
          ...
          <Button type="submit" variant="default" className="bg-green-600 text-white hover:bg-green-600/90">
            Cambiar a Admin
          </Button>
        </form>
        ...
        <form action={setRoleWrapper} className="flex items-center space-x-4">
          ...
          <Button type="submit" variant="secondary" className="border border-white bg-yellow-600 text-white hover:bg-yellow-600/90">
            Cambiar a Educador
          </Button>
        </form>
        ...
        <form action={removeRoleWrapper} className="flex items-center space-x-4">
          <input type="hidden" value={user.id} name="id" />
          <Button type="submit" variant="destructive" className="border border-white">
            Eliminar Role
          </Button>
        </form>
      </div>
