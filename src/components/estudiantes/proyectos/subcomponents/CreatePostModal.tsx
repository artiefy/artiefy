 ...
 * the desktop "Crear" dropdown and the mobile bottom-sheet, both of which
 * only decide *when* to open it — everything below is self-contained.
 */
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        ...
        >
          ...
          <button
            ...
            `}
          >
            {isSubmitting ? 'Publicando...' : 'Previsualizar'}
          </button>
        </div>
      </DialogContent>
    </Dialog>
