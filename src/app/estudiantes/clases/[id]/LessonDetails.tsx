	...
	const renderLessonCard = (lessonItem: LessonWithProgress) => {
		...
		return (
			<div
				...
				className={`mb-2 rounded-lg p-4 transition-all ${isAccessible ? 'cursor-pointer hover:bg-blue-50' : 'cursor-not-allowed opacity-75'} ${isCurrentLesson ? 'border-l-4 border-blue-500 bg-blue-50' : 'bg-gray-50'} ${isCompleted ? 'border-blue-500' : ''} `}
			>
				<div className="mb-2 flex items-center justify-between">
					<h3
						className={`font-semibold ${isAccessible ? 'text-gray-900' : 'text-gray-500'}`}
					>
			...
			<div className="flex min-h-screen flex-col bg-background">
				<div className="flex flex-1 px-4 py-6">
					...
					<div className="w-72 bg-background p-4 shadow-lg">
						<h2 className="mb-4 items-end text-2xl font-bold text-primary">
							Actividades
						</h2>
						{activity ? (
