  ...
  return (
    ...
    >
      {forums.map((forum) => {
        ...
        const ownerTypeLabel = forum.guidedProject
          ? 'Proyecto guiado:'
          : 'Curso:';
        const ownerLabel =
          forum.course?.title ?? forum.guidedProject?.title ?? 'Sin asignar';
            ...
            >
              ...
              <CardContent className="flex grow flex-col justify-between space-y-3 px-2 pb-2">
                ...
                >
                  ...
                  "
                  >
                    <p className="text-xs text-primary">{ownerTypeLabel}</p>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            <strong>{forum.title}</strong> y todo su contenido
                            asociado.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
