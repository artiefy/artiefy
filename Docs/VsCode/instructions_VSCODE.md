...
URL Source: https://code.visualstudio.com/docs/copilot/customization/custom-instructions
...
## [Types of instruction files](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_types-of-instruction-files)
...
### [Always-on instructions](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_alwayson-instructions)
...
- A single [`.github/copilot-instructions.md`](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-a-githubcopilot-instructionsmd-file) file
  - Automatically applies to all chat requests in the workspace
  - Stored within the workspace

- One or more [`AGENTS.md`](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-an-agentsmd-file) files
...
- [Organization-level instructions](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_share-custom-instructions-across-teams)
...
- [`CLAUDE.md`](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-a-claudemd-file) file
...
### [File-based instructions](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_filebased-instructions)
...
- One or more [`.instructions.md`](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-instructionsmd-files) files
...
## [Use a .github/copilot-instructions.md file](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-a-githubcopilotinstructionsmd-file)
...
VS Code also supports the use of an [`AGENTS.md` file](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-an-agentsmd-file) for always-on instructions.
...
### [Instructions file locations](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_instructions-file-locations)
...
| User profile | `prompts` folder of the current [VS Code profile](https://code.visualstudio.com/docs/configure/profiles) |
...
### [Create an instructions file](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_create-an-instructions-file)
...
![Image 1: Screenshot showing the Chat view, and Configure Chat menu, highlighting the Configure Chat button.](https://code.visualstudio.com/assets/docs/copilot/customization/configure-chat-instructions.png)
...
## [Use an AGENTS.md file](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-an-agentsmd-file)
...
### [Use multiple AGENTS.md files (experimental)](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-multiple-agentsmd-files-experimental)
...
For folder-specific instructions, you can also use multiple [`.instructions.md`](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-instructionsmd-files) files with different `applyTo` patterns that match the folder structure.

## [Use a CLAUDE.md file](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-a-claudemd-file)
...
## [Generate custom instructions for your workspace](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_generate-custom-instructions-for-your-workspace)
...
### [Use the /init slash command](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-the-init-slash-command)
...
The `/init` command is implemented as a contributed [prompt file](https://code.visualstudio.com/docs/copilot/customization/prompt-files), so you can customize its behavior by modifying the underlying prompt.

### [Use a command to generate instructions](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_use-a-command-to-generate-instructions)
...
## [Sync user instructions files across devices](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_sync-user-instructions-files-across-devices)
...
## [Specify custom instructions in settings](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_specify-custom-instructions-in-settings)
...
For specialized scenarios like code review or commit message generation, you can use VS Code settings to define custom instructions. For general coding instructions, use [file-based instructions](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_types-of-instruction-files) instead.
...
## [Instruction priority](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_instruction-priority)
...
## [Frequently asked questions](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_frequently-asked-questions)

### [Why is my instructions file not being applied?](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_why-is-my-instructions-file-not-being-applied)

Tip

Use the chat customization diagnostics view to see all loaded instruction files and any errors. Right-click in the Chat view and select **Diagnostics**. Learn more about [troubleshooting AI in VS Code](https://code.visualstudio.com/docs/copilot/troubleshooting).
...
chat.instructionsFilesLocations setting (default: `.github/instructions`) or in your user profile.
...
chat.includeApplyingInstructions for pattern-based instructions, chat.includeReferencedInstructions for instructions referenced via Markdown links, chat.useAgentsMdFile for `AGENTS.md` files.
...
### [How do I know where a custom instruction file comes from?](https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_how-do-i-know-where-a-custom-instruction-file-comes-from)
...
1.  Select **Chat: Configure Instructions** from the Command Palette (⇧⌘P).
...
All VS Code docs are open source. See something that's wrong or unclear? [Submit a pull request](https://vscode.dev/github/microsoft/vscode-docs/blob/main/docs/copilot/customization/custom-instructions.md).
