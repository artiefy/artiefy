...
export async function getTicketWithMessages(ticket_id: number, user_id?: string): Promise<{
    ticket: typeof tickets.$inferSelect | undefined;
...
export async function SaveTicketMessage(
  ...
  if (ticket.id === undefined) {
    throw new Error('No se pudo obtener el ID del ticket para guardar el comentario.');
  }
