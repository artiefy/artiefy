        ...
        <Card key={course.id} className="overflow-hidden">
          ...
          <CardContent className="p-3">
            ...
            <div className="mb-2 flex items-center">
              ...
              <span className="ml-2 text-sm font-bold text-gray-600">Categoría</span>
            </div>
          ...
          <CardFooter className="flex items-center justify-between px-3">
            <Button onClick={() => onEdit(course)} className="mr-4 bg-orange-500 text-white hover:bg-orange-500/90">
              Editar
            </Button>
