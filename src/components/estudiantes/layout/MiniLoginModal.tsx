...
export default function MiniLoginModal({
  ...
  const modalContent = (
    <div
      className="
        pointer-events-auto fixed inset-0 z-[1200] overflow-y-auto bg-black/50
      "
    >
      <div className="flex min-h-full items-center justify-center p-4">
        <div
          ...
          className="
            ...
            relative z-50 grid max-h-[calc(100dvh-2rem)] w-full max-w-lg gap-4
            overflow-y-auto rounded-[32px] border border-border/50
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            ...
            <div
              className="
                animate-float absolute top-1/2 right-4 h-28 w-20
            ...
            >
              <div className="relative size-full rotate-[-15deg]">
                ...
                >
                  ...
                  <path
                    d="M32 4 L32 52 L16 52 Z"
                    fill="url(#loginRocketDark)"
                  />
                  <path
          ...
          {/* Info message (e.g., new account created) */}
          {infoMessage && (
            <div
              className="
                relative z-10 rounded-lg border border-accent/30 bg-accent/10
