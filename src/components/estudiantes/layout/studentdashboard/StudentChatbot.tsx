			...
			{isOpen && isSignedIn && (
				...
				>
					...
					>
						...
						{/* Custom diagonal resize handles */}
						<div className="diagonal-handles">
							<div className="react-resizable-handle react-resizable-handle-se">
								⋮⋮
							</div>
							<div className="react-resizable-handle react-resizable-handle-sw">
								⋮⋮
							</div>
							<div className="react-resizable-handle react-resizable-handle-ne">
								⋮⋮
							</div>
							<div className="react-resizable-handle react-resizable-handle-nw">
								⋮⋮
							</div>
						</div>

						{/* Vertical and horizontal resize handles */}
						<div className="edge-handles">
							<div className="react-resizable-handle react-resizable-handle-n">
								⋮⋮
							</div>
