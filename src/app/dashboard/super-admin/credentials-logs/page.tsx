...
export default function CredentialsLogsPage() {
    ...
    async function saveNota() {
        ...
        setSaving(true);
        try {
            const res = await fetch(`/api/super-admin/form-inscription/credentials-logs/${modalItem.id}`, {
                method: "PATCH",
    ...
    return (
        <div className="p-4 md:p-6">
            <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-white">Logs de Credenciales</h1>
                ...
                <div className="flex gap-2">
                    <div className="relative">
                        ...
                        <input
                            className="w-72 rounded-lg border border-gray-700 bg-gray-900 px-8 py-2.5 text-sm font-medium text-white placeholder:text-gray-500 outline-none focus:border-primary focus:ring-1 focus:ring-primary"
            ...
            <div className="overflow-hidden rounded-xl border border-gray-800 bg-gray-900">
                <table className="w-full text-left text-sm text-gray-200">
                    <thead className="bg-gray-800 text-xs font-semibold uppercase tracking-wider text-gray-300">
                        <tr>
                    ...
                    <tbody>
                        ...
                        {!loading &&
                            items.map((it) => (
                                <tr key={it.id} className="border-t border-gray-800 transition-colors hover:bg-gray-850">
                                    ...
                                    <td className="px-5 py-4 font-mono text-base">
                                        {it.contrasena ? "••••••••" : <span className="text-gray-500">—</span>}
                                    </td>
                    ...
                    <div className="w-full max-w-lg rounded-2xl border border-gray-800 bg-gray-900 p-6">
                        ...
                        <div className="space-y-3 text-base text-gray-200">
                            <div>
                                ...
                                <span className="font-medium text-white">{modalItem.usuario}</span>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <span className="font-mono text-lg text-white">{modalItem.contrasena ?? "—"}</span>
                            </div>
                            <div>
                                <span className="font-medium text-gray-400">Fecha: </span>
                                <span className="text-sm text-gray-300">{new Date(modalItem.createdAt).toLocaleString("es-CO")}</span>
                            </div>
                            ...
                            <div className="pt-3">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-gray-700 bg-gray-950 px-4 py-2.5 text-base text-white outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary"
                                />
                            </div>
                        </div>
                        ...
                        <div className="mt-6 flex justify-end gap-3">
                            ...
                            <button
                                disabled={saving}
                                onClick={saveNota}
                                className="rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-black transition-opacity hover:opacity-90 disabled:opacity-50"
                            >
