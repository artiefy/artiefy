...
>(({ className, ...props }, ref) => (
<<<<<<< HEAD:src/components/estudiantes/ui/toast.tsx
...
=======
	<ToastPrimitives.Action
		ref={ref}
		className={cn(
			'group-[.destructive]:border-muted/40 hover:group-[.destructive]:border-destructive/30 hover:group-[.destructive]:bg-destructive hover:group-[.destructive]:text-destructive-foreground focus:group-[.destructive]:ring-destructive hover:bg-secondary focus:ring-ring inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium transition-colors focus:ring-1 focus:outline-hidden disabled:pointer-events-none disabled:opacity-50',
			className
		)}
		{...props}
	/>
>>>>>>> 106ed634249738e068cde72c88c34ba752c1728a:src/components/super-admin/ui/toast.tsx
));
