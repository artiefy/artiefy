...
export default function CourseCarousel({ courses, userId }: Props) {
  ...
  useEffect(() => {
    ...
    // Solo suscribimos el evento aquí
    return () => {
      emblaApi.off('select', onSelect);
    };
  }, [emblaApi, onSelect]);

  // Inicializar el estado de los botones tras montar emblaApi (sin cascada)
  useEffect(() => {
    if (!emblaApi) return;
          ...
          {courses.map((course) => (
            <div
              ...
              className="
                ...
                duration-300
                hover:scale-[1.03] hover:shadow-[0_0px_25px_rgba(0,189,216,0.6)]
              "
            >
              {/* Imagen */}
              ...
              <div className="p-2 text-white">
                <p className="text-xs font-semibold text-primary">Nombre:</p>
              ...
              >
                ...
                <div className="flex w-full items-center justify-between">
                  ...
                  <Link
                    ...
                    "
                  >
                    <p className="font-bold">Ver detalles del estudiante</p>
      ...
      {courses.length > 4 && (
        <>
          <button
            ...
            onClick={() => {
              emblaApi?.scrollPrev();
              setTimeout(() => onSelect(), 100); // Forzar actualización tras scroll
            }}
