							...
							<form onSubmit={handleSubmit}>
								<div className="flex justify-center">
									<input
										...
										required
										className={`w-full rounded-none bg-transparent px-4 py-2.5 text-sm ring-1 outline-hidden ring-inset sm:w-[250px] md:w-[300px] lg:w-[330px] xl:w-[350px] ${emailError ? 'ring-rose-400' : 'ring-white/20'} focus:ring-primary hover:ring-white/30 focus:ring-[1.5px] focus:shadow-[0_0_6px_0] focus:shadow-emerald-500/20 data-invalid:shadow-rose-400/20 data-invalid:ring-rose-400`}
									/>
								</div>
								<div className="mt-4 flex justify-center">
									<input
										...
										required
										className={`w-full rounded-none bg-transparent px-4 py-2.5 text-sm ring-1 outline-hidden ring-inset sm:w-[250px] md:w-[300px] lg:w-[330px] xl:w-[350px] ${passwordError ? 'ring-rose-400' : 'ring-white/20'} focus:ring-primary hover:ring-white/30 focus:ring-[1.5px] focus:shadow-[0_0_6px_0] focus:shadow-emerald-500/20 data-invalid:shadow-rose-400/20 data-invalid:ring-rose-400`}
									/>
								</div>
								<div className="mt-6 flex justify-center">
									<button
										type="submit"
										className="text-primary ring-primary active:text-primary/70 rounded-none px-3.5 py-2.5 text-center text-sm font-medium italic ring-1 shadow-sm ring-inset hover:bg-white/30 focus-visible:outline-[1.5px] focus-visible:outline-offset-2 focus-visible:outline-zinc-950 active:scale-95"
										style={{ width: '150px' }}
							...
							<form onSubmit={handleResetPassword}>
								<div>
									<input
										...
										required
										className="focus:ring-primary w-full rounded-none bg-transparent px-4 py-2.5 text-sm ring-1 ring-white/20 outline-hidden ring-inset hover:ring-white/30 focus:ring-[1.5px] focus:shadow-[0_0_6px_0] focus:shadow-emerald-500/20"
									/>
								</div>
								<div className="mt-4">
									<input
