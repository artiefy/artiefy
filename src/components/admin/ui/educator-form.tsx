...
export function EducatorForm({ open, onOpenChangeAction, educator, onSubmitAction }: EducatorFormProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChangeAction}>
      <DialogContent className="sm:max-w-[525px w-full] bg-white">
        <DialogHeader>
          <DialogTitle>{educator ? "Editar Educador" : "Nuevo Educador"}</DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmitAction)} className="space-y-4 p-4 sm:p-6 bg-white rounded-lg shadow">
            <FormField
            ...
            <div className="flex justify-end gap-2 text-right text-white">
              ...
              <Button className="text-black" type="submit">{educator ? "Guardar Cambios" : "Crear Educador"}</Button>
            </div>
          </form>
        </Form>
      </DialogContent>
