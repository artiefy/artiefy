...
const COACH_COLOR = 'rgb(50, 200, 180)';

/** Artiefy brand cyan, used by the floating launcher across every agent. */
const LAUNCHER_COLOR = '#22C4D3';

/**
 * Minimal shape the widget needs from a guided project. Kept structural on
 * purpose so the widget does not depend on the full GuidedProject type.
 */
...
export interface CoachChatWidgetProps {
  projectId: number;
  projectTitle: string;
...
export function CoachChatWidget({
  ...
  const isObjectiveExpanded = (objective: CoachObjective) =>
  ...
  if (!isOpen) {
    return (
      <button
        type="button"
        aria-label="Abrir chat con Coach"
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          boxShadow:
            'rgba(4, 6, 11, 0.6) 0px 8px 40px, rgba(50, 200, 180, 0.15) 0px 0px 1px',
        }}
      >
        {/* Header */}
        <div
          ...
          style={{
            ...
            background:
              'linear-gradient(135deg, rgba(50, 200, 180, 0.06), rgba(124, 59, 237, 0.03), transparent)',
          }}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg, rgba(50, 200, 180, 0.25), rgba(50, 200, 180, 0.08))',
                  boxShadow: 'rgba(50, 200, 180, 0.15) 0px 0px 20px',
                }}
              >
                <Rocket className="size-5" style={{ color: COACH_COLOR }} />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    style={{
                      backgroundColor: 'rgba(50, 200, 180, 0.12)',
                      color: COACH_COLOR,
                    }}
                  >
                    Proyectos
        ...
        <div className="scrollbar-minimal flex flex-1 flex-col overflow-y-auto">
          ...
          {currentActivity && (
            <button
              ...
              style={{
                borderColor: 'rgba(50, 200, 180, 0.25)',
                background:
                  'linear-gradient(135deg, rgba(50, 200, 180, 0.12), rgba(50, 200, 180, 0.04))',
              }}
            >
              <div
                className="flex size-8 flex-shrink-0 items-center justify-center rounded-lg"
                style={{ background: 'rgba(50, 200, 180, 0.2)' }}
              >
                <Play
          ...
          <div className="pt-2">
            <div
              ...
              style={{
                borderColor: 'rgba(50, 200, 180, 0.15)',
                background:
                  'linear-gradient(135deg, rgba(50, 200, 180, 0.05), rgba(50, 200, 180, 0.02))',
              }}
            >
              <button
                type="button"
              ...
              >
                <div
                  ...
                  style={{ background: 'rgba(50, 200, 180, 0.15)' }}
                >
                  <FolderKanban
                    className="size-3.5"
                    style={{ color: COACH_COLOR }}
              ...
              {isTreeOpen && (
                <div
                  ...
                  style={{ borderColor: 'rgba(50, 200, 180, 0.1)' }}
                >
                  {objectives.map((objective) => {
                    const activities = objective.activities ?? [];
                    const done = activities.filter((a) => a.isCompleted).length;
                      ...
                      <div key={objective.id} className="pt-1.5">
                        ...
                        {expanded && (
                          <div
                            ...
                            style={{ borderColor: 'rgba(50, 200, 180, 0.15)' }}
                          >
                                ...
                                <button
                                  ...
                                  style={
                                    isActive && !activity.isCompleted
                                      ? {
                                          background: 'rgba(50, 200, 180, 0.1)',
                                          boxShadow:
                                            'rgba(50, 200, 180, 0.2) 0px 0px 0px 1px inset',
                                        }
                                      : undefined
                                  }
                                >
        ...
        >
          <div className="scrollbar-minimal flex gap-2 overflow-x-auto px-4 pb-1">
            {[
              'Cursos',
              'Proyectos',
              'Spaces',
              ...
              <button
                key={chip}
                type="button"
                className="shrink-0 rounded-full border px-3 py-1.5 text-xs font-medium transition-all hover:scale-[1.03]"
                style={{
                  borderColor: 'rgba(50, 200, 180, 0.2)',
                  color: COACH_COLOR,
                  backgroundColor: 'rgba(50, 200, 180, 0.08)',
                }}
              >
                {chip}
              </button>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              placeholder={
                isSending ? 'Coach está pensando...' : 'Escribe tu mensaje...'
              }
            ...
            <button
              ...
              style={{ backgroundColor: COACH_COLOR, color: 'rgb(8, 12, 22)' }}
            >
