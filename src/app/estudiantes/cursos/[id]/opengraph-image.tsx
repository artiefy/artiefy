...
export default async function Image({ params }: { params: { id: string } }) {
  try {
    ...
    return new ImageResponse(
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1425.83 417.61" width="300" height="87.5">
          <rect x="43.779" y="14.057" width="1347.11" height="380.757" fill="#01142B" rx="28.115" ry="28.115" />
          <g transform="matrix(0.726766, 0, 0, 0.661497, 199.200717, 66.296296)">
            <polygon points="144.99 218.15 192.75 201.16 194.56 201.83 194.83 117.23 144.99 218.15" fill="#FFFFFF" />
            <polygon points="107.13 343.13 194.11 343.13 194.48 225.93 194.12 225.42 107.13 343.13" fill="#FFFFFF" />
            <path
            ...
            <polygon
              ...
              fill="#FFFFFF"
            />
            <rect x="733.51" y="166.14" width="57.11" height="178.26" fill="#FFFFFF" />
            <path
