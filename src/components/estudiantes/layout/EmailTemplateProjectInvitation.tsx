...
export function EmailTemplateProjectInvitation({
  invitedUserName,
  invitedByUserName,
  projectName,
  invitationMessage,
          ...
          ">
            ...
            ">
              ...
              <p style="color:#01142B;font-size:1.2rem;font-weight:600;margin-bottom:20px;">
                ${invitedByUserName} te ha invitado a colaborar en un proyecto.
              </p>
              <div style="text-align:left;background:#f8fafc;border-radius:12px;padding:16px;margin-bottom:20px;">
                ...
                ${
                  invitationMessage
                    ? `<p style="margin:0 0 8px 0;color:#01142B;font-size:0.95rem;"><strong>Mensaje:</strong> ${invitationMessage}</p>`
                    : ''
                }
              </div>
              <p style="color:#01142B;font-size:1rem;margin-bottom:28px;">
                Como invitado, podrás subir entregables y links de las actividades del proyecto.
              </p>
              ...
              <p style="color:#01142B;font-size:0.9rem;margin-top:24px;">
                Si no deseas aceptar esta invitación, puedes ignorar este mensaje.
              </p>
            </div>
          </div>
        </div>
