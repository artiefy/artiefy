...
const ResponsiveSidebar = ({ children }: ResponsiveSidebarProps) => {
	...
	return (
		<div className="bg-background min-h-screen">
			{/* Navbar */}
			<nav className="bg-background fixed top-0 z-50 w-full border-b border-gray-200 shadow-sm">
				<div className="p-3 lg:px-5 lg:pl-3">
					<div className="flex items-center justify-between">
						<div className="flex items-center">
							<button
								onClick={() => isMobile && setIsOpen(!isOpen)}
								className="rounded-lg p-2 text-gray-600 hover:bg-gray-100 focus:ring-2 focus:ring-gray-200 focus:outline-none md:hidden"
