        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <p className="text-2xl font-bold">{estudiante.promedioGeneral.toFixed(2)}</p>
            </div>
            <div>
              <p className="text-sm font-medium">Tasa de Finalización</p>
              <p className="text-2xl font-bold">{estudiante.tasaFinalizacion}%</p>
            </div>
            <div>
              <p className="text-sm font-medium">Tiempo Promedio de Completado</p>
              <p className="text-2xl font-bold">{estudiante.tiempoPromedioCompletado} días</p>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <ChartContainer config={{
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={datosGrafico}>
                ...
                <Bar dataKey="progreso" fill="var(--color-progreso)" name="Progreso" />
                <Bar dataKey="calificacion" fill="var(--color-calificacion)" name="Calificación" />
              </BarChart>
            </ResponsiveContainer>
          </ChartContainer>
        </CardContent>
