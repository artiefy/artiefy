...
export const env = createEnv({
  ...
  server: {
    ...
    PAYU_MODE: z.enum(['sandbox', 'production']).optional(),
    PAYU_TEST_MERCHANT_ID: z.string().optional(),
    PAYU_TEST_ACCOUNT_ID: z.string().optional(),
    PAYU_TEST_API_LOGIN: z.string().optional(),
    PAYU_TEST_API_KEY: z.string().optional(),
    PAYU_PROD_MERCHANT_ID: z.string().optional(),
    PAYU_PROD_ACCOUNT_ID: z.string().optional(),
    PAYU_PROD_API_LOGIN: z.string().optional(),
    PAYU_PROD_API_KEY: z.string().optional(),
    PAYU_API_URL: z.url(),
    RESPONSE_URL: z.url(),
  ...
  runtimeEnv: {
    ...
    PAYU_MODE: process.env.PAYU_MODE as 'sandbox' | 'production' | undefined,
    PAYU_TEST_MERCHANT_ID: process.env.PAYU_TEST_MERCHANT_ID,
    PAYU_TEST_ACCOUNT_ID: process.env.PAYU_TEST_ACCOUNT_ID,
    PAYU_TEST_API_LOGIN: process.env.PAYU_TEST_API_LOGIN,
    PAYU_TEST_API_KEY: process.env.PAYU_TEST_API_KEY,
    PAYU_PROD_MERCHANT_ID: process.env.PAYU_PROD_MERCHANT_ID,
    PAYU_PROD_ACCOUNT_ID: process.env.PAYU_PROD_ACCOUNT_ID,
    PAYU_PROD_API_LOGIN: process.env.PAYU_PROD_API_LOGIN,
    PAYU_PROD_API_KEY: process.env.PAYU_PROD_API_KEY,
