    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex items-center gap-3">
          <PiCertificate className="size-8 text-primary" />
          <h1 className="text-3xl font-bold text-primary">Mis Certificados</h1>
        </div>
                  ...
                  {userCertificates
                    ...
                    .map((certificate) => (
                      <Card
                        key={certificate.id}
                        className="
                          poster-certificado mx-auto flex min-h-[420px] max-w-xs
                          flex-col items-center overflow-hidden rounded-2xl
                          border border-gray-200 bg-gradient-to-b from-blue-900
                          via-[#01142B] to-cyan-900 p-0 shadow-xl
                        "
                      >
                        <CardHeader
                          className="
