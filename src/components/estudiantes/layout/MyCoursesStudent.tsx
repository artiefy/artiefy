...
export default async function MyCoursesStudent() {
  ...
  return (
    <div className="container mx-auto mb-22 px-4">
      ...
      {/* Wrapper for Programs and Courses Sections */}
      <div className="rounded-lg bg-[#061c37] p-6">
        {/* Programs Section */}
        {programs.length > 0 && (
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              {programs.map((program: Program) => (
                <Card
                  key={program.id}
                  className="overflow-hidden bg-[#01152d] py-0 text-white"
                >
                      ...
                      <div className="flex h-full flex-col justify-start gap-4">
                        <div className="space-y-2">
                          <div className="flex flex-col items-start justify-between gap-2 md:flex-row">
                            <h3 className="text-lg leading-normal font-bold break-words text-primary md:text-lg">
                              {program.title}
                            </h3>
                            ...
                            <div className="grid grid-cols-2 items-center gap-2">
                              ...
                              <Button asChild className="h-8 px-2">
                                <Link
                                  ...
                                  className="group/button relative inline-flex items-center justify-center overflow-hidden rounded-md border border-white/20 bg-background text-primary active:scale-95"
                                >
                                  <p className="text-sm font-bold">Continuar</p>
                                  <ArrowRightCircleIcon className="ml-1 size-4 animate-bounce-right" />
                                  <div className="absolute inset-0 flex w-full [transform:skew(-13deg)_translateX(-100%)] justify-center group-hover/button:[transform:skew(-13deg)_translateX(100%)] group-hover/button:duration-1000">
                                    <div className="relative h-full w-10 bg-white/30" />
                                  </div>
                                </Link>
