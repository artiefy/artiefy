  ...
  const [insignias, setInsignias] = useState([
    {
      ...
      descripcion: 'Completar el primer curso',
      puntos: 50,
    },
    {
      id: 2,
      nombre: 'Maestro del Foro',
      descripcion: 'Hacer 100 publicaciones útiles',
      puntos: 200,
    },
    {
      id: 3,
      nombre: 'Estudiante Estrella',
      descripcion: 'Obtener calificación perfecta en 5 cursos',
      puntos: 500,
    },
  ]);
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewInsignia({ ...newInsignia, nombre: e.target.value })
                }
