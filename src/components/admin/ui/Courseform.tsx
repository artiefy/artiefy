...
export function CourseForm({ onSubmit, initialData }: CourseFormProps) {
  ...
  const [newLesson, setNewLesson] = useState({ title: '', duration: 0, description: '' });
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <Select onValueChange={handleCategoryChange} defaultValue={course.category?.name}>
          <SelectTrigger>
      ...
      <div>
        ...
        <Select onValueChange={handleModalidadChange} defaultValue={course.modalidad?.name}>
          <SelectTrigger>
