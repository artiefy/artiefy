							...
							<div className="flex flex-col gap-4">
								<div className="flex gap-2">
									<input
										...
										className="flex-1 rounded-lg border border-gray-300 px-4 py-2 font-semibold text-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
							...
							<div className="grid grid-cols-1 gap-6 md:grid-cols-2">
								<div className="space-y-4">
									...
									<input
										...
										className="w-full rounded-lg border border-gray-300 px-4 py-2 text-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500"
										min="1"
									/>
								</div>
									...
									<div className="flex items-center gap-4">
										...
										{isTimerEnabled && (
											<input
												...
												className="w-32 rounded-lg border border-gray-300 px-4 py-2 text-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500"
												min="30"
												step="30"
											/>
										)}
