...
const ResponsiveSidebar = ({ children }: ResponsiveSidebarProps) => {
	...
	return (
		<div className="min-h-screen bg-background">
			{/* Navbar */}
			<nav className="fixed top-0 z-50 w-full border-b border-gray-200 bg-background shadow-xs">
			...
			<aside
				className={cn(
					'fixed top-0 left-0 z-40 h-screen w-64 border-r border-gray-200 bg-background pt-20 transition-transform sm:translate-x-0 dark:border-gray-700 dark:bg-gray-800',
