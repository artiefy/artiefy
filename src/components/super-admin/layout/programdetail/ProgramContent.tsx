...
export function ProgramContent({ program, isEnrolled }: ProgramContentProps) {
  ...
  return (
    <div className="force-light relative rounded-lg border bg-white p-6 shadow-sm">
      ...
      >
        {courses.map((course, index) => (
          <div key={`${course.id}-${index}`} className="group relative">
            <div
              className="
              absolute -inset-2 animate-gradient rounded-xl bg-linear-to-r
                ...
                <div className="flex w-full items-center justify-between">
                  ...
                  >
                    <Link
                      ...
                      className="
                        group/button relative inline-flex h-10
                        items-center justify-center overflow-hidden rounded-md
                        border border-white/20 bg-background p-2 text-primary
                        active:scale-95
                      "
