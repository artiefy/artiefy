			...
			<form onSubmit={handleSubmit} className="space-y-4">
				<div>
					...
					<textarea
						...
						className="text-background mt-1 block w-full rounded-md border-gray-300 shadow-xs placeholder:text-gray-400 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
						style={{
							height: '100px',
							padding: '10px',
							caretColor: 'black',
				...
				<button
					type="submit"
					className="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-xs hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden active:scale-95"
				>
					Enviar
				</button>
			</form>
