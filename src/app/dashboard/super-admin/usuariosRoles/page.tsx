  ...
  return (
    ...
    ">
      <header className="group relative mb-6 overflow-hidden rounded-lg p-[1px]">
        <div className="
          animate-gradient absolute -inset-0.5 bg-gradient-to-r from-[#3AF4EF]
          via-[#00BDD8] to-[#01142B] opacity-75 blur transition duration-500
        " />
        <div className="
          relative flex flex-col rounded-lg bg-gray-800 p-4 text-white shadow-lg
      ...
      ">
        <button
          ...
          className={`
            w-full rounded px-4 py-2 text-center
            sm:w-auto
            ${
            activeTab === 'permisos'
