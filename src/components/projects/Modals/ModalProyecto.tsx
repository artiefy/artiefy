...
const ModalProyecto: React.FC<ModalProyectoProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="
        relative flex h-auto max-h-[90vh] w-full max-w-4xl flex-col
        overflow-hidden rounded-lg bg-[#3f4a56] shadow-lg
      ...
      >
        ...
        <button
          className="
            absolute top-2 right-3 z-10 text-lg font-bold text-gray-200
            hover:text-white
            sm:text-xl
          "
          onClick={onClose}
        ...
        <div
          className="
          flex w-full items-center justify-center bg-[#0F2940] p-4
          md:w-1/2 md:p-8
        "
        >
          <div
        ...
        <div
          className="
          w-full overflow-y-auto p-4 text-white
          md:w-1/2 md:p-6
        "
        >
          <h2
            className="
            mb-4 text-2xl font-bold text-cyan-300
            sm:text-3xl
            md:text-4xl
          "
          >
          ...
          <div
            className="
            mb-4 flex flex-col gap-2 font-semibold
            sm:flex-row sm:gap-4
          "
          >
            <div
              className="
              flex items-center gap-1 rounded bg-[#1F3246] px-3 py-1 text-lg
              text-cyan-300
              hover:scale-105
              sm:text-xl
            "
            ...
            <div
              className="
              flex items-center gap-1 rounded bg-[#2f2f2f] px-3 py-1 text-lg
              text-purple-400
              sm:text-xl
            "
            >
          ...
          <button
            className="
              w-full rounded bg-cyan-700 px-4 py-2 text-base font-semibold
              text-white
              hover:bg-cyan-600
              sm:text-lg
            "
