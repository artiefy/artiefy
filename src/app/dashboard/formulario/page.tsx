...
export default function FormInscriptionPage() {
  ...
  return (
    <>
      <div
        className="
          min-h-screen w-full bg-gradient-to-br from-[#01060f] to-[#0e1a2b] px-6
          py-12 text-white
        "
      >
        <div
          className="
            mx-auto max-w-3xl rounded-xl border border-gray-700 bg-gray-900 p-10
        ...
        >
          ...
          <div className="mb-8">
            <h2
              className="
                mb-4 text-center text-sm tracking-widest text-gray-400 uppercase
              "
            >
              Organiza
            </h2>
            <div
              className="
                mx-auto flex max-w-2xl flex-wrap items-center justify-center
                gap-6
                sm:gap-10
              "
            >
          ...
          <h1
            className="
              mb-3 text-center text-3xl font-extrabold tracking-tight
              text-cyan-400
              sm:text-4xl
            "
          >
          ...
          <div className="flex justify-center">
            <button
              ...
              className="
                rounded bg-cyan-500 px-6 py-3 text-lg font-semibold text-black
                shadow-md transition
                hover:bg-cyan-400 hover:shadow-cyan-300
