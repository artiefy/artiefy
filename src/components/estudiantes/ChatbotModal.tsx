  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 rounded-full bg-background p-4 text-white shadow-lg transition-all duration-300 hover:bg-background/80"
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div
            ...
            className="flex max-h-[80vh] w-full max-w-md flex-col rounded-lg bg-background shadow-xl"
          >
            ...
            <div className="flex-1 space-y-4 overflow-y-auto p-4">
              {messages.map((message) => (
                ...
                >
                  ...
                  >
                    {message.sender === 'bot' ? (
                      <FaRobot className="mt-2 text-xl text-primary" />
                    ) : (
            ...
            >
              <div className="flex space-x-2">
                <input
                  ...
                  className="flex-1 rounded-lg border border-gray-300 p-2 text-background focus:outline-none focus:ring-2 focus:ring-primary"
                  disabled={isLoading}
                />
                <button
                  type="submit"
                  disabled={isLoading}
                  className="rounded-lg bg-primary p-2 text-white transition-colors hover:bg-primary/80 disabled:bg-primary/50"
