									...
									<div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
										<div className="space-y-4">
											...
											<input
												...
												className="w-full rounded-lg border border-gray-300 px-4 py-2 font-semibold text-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:outline-hidden"
												min="1"
											/>
										</div>
											...
											<div className="flex items-center gap-4 text-indigo-800">
												...
												{config.isTimerEnabled && (
													<input
														...
														className="w-32 rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-indigo-500 focus:outline-hidden"
														min="30"
														step="30"
													/>
												)}
